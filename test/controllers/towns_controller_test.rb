...
class TownsControllerTest < ActionController::TestCase
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post :create, town: { lattitude: @town.lattitude, longitude: @town.longitude, name: @town.name, postal_code: @town.postal_code }
    end
  ...
  test "should update town" do
    patch :update, id: @town, town: { lattitude: @town.lattitude, longitude: @town.longitude, name: @town.name, postal_code: @town.postal_code }
    assert_redirected_to town_path(assigns(:town))
  end
